...
export async function GET(req: NextRequest) {
  ...
  const doc = createElement(
    ...
    createElement(Page, { size: "A4", orientation: "landscape", style: styles.page },
      ...
      createElement(View, { style: styles.thead },
        ...
        createElement(Text, { style: { ...styles.thText, flex: 0.7 } }, "Mission"),
      ...
      ...enrollments.map((e, i) => {
        ...
        return createElement(View, { key: e.id, style: rowStyle },
          ...
          createElement(Text, { style: { ...styles.cell, flex: 0.7 } }, e.trainee.homeMission?.code ?? "—"),
      ...
      createElement(View, { style: styles.tfoot },
        createElement(Text, { style: { ...styles.tfCell } }, `Total: ${enrollments.length} ${enrollments.length !== 1 ? "Missionaries" : "Missionary"}`),
      ),
  ...
  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      ...
      "Content-Disposition": `inline; filename="missionaries.pdf"`,
    },
  });
}
