...
export async function GET(req: NextRequest) {
    ...
    createElement(Page, { size: "A4", orientation: "landscape", style: styles.page },
      createElement(View, { style: styles.header },
        ...
        createElement(View, { style: styles.hCenter },
          ...
          createElement(Text, { style: styles.subtitle }, "Deployed Missionaries List"),
      ...
      createElement(View, { style: styles.thead },
        ...
        createElement(Text, { style: { ...styles.thText, flex: 0.8 } }, "Deployed To"),
        createElement(Text, { style: { ...styles.thText, flex: 1.2 } }, "Start Date"),
      ...
      ...deployments.map((d, i) => {
        ...
        return createElement(View, { key: d.id, style: rowStyle },
          createElement(Text, { style: { ...styles.cell, flex: 0.35 } }, String(i + 1)),
          createElement(Text, { style: { ...styles.cellBold, flex: 2.2 } }, d.missionary.fullName),
          createElement(Text, { style: { ...styles.cell, flex: 2 } }, d.missionary.fullNameBangla ?? "—"),
          createElement(Text, { style: { ...styles.cell, flex: 1.2 } }, app?.referenceNumber ?? "—"),
          createElement(Text, { style: { ...styles.cell, flex: 0.8 } }, prog?.code ?? "—"),
          createElement(Text, { style: { ...styles.cell, flex: 0.8 } }, d.mission.code),
          createElement(Text, { style: { ...styles.cell, flex: 1.2 } }, fmt(d.startDate)),
          createElement(Text, { style: { ...styles.cell, flex: 0.6 } }, app?.applicantGender === "MALE" ? "M" : "F"),
          createElement(Text, { style: { ...styles.cell, flex: 1.4 } }, app?.presentAddressDistrict ?? "—"),
        );
      }),
      createElement(View, { style: styles.tfoot },
        createElement(Text, { style: { ...styles.tfCell } }, `Total: ${deployments.length} ${deployments.length !== 1 ? "Missionaries" : "Missionary"}`),
      ),
  ...
  return new NextResponse(new Uint8Array(buffer), {
    headers: {
      ...
      "Content-Disposition": `inline; filename="deployed-missionaries.pdf"`,
    },
  });
}
