...
export function DirectorMissionariesExportButton({ year, month, gender, programId, mission }: Props) {
  ...
  function buildUrl(format: "pdf" | "xlsx") {
    ...
    const base = format === "pdf"
      ? "/api/export/director-missionaries/pdf"
      : "/api/export/director-missionaries/xlsx";
