...
export function LmdDeployedMissionariesExportButton({ year, month, gender, district, programId }: Props) {
  ...
  function buildUrl(format: "pdf" | "xlsx") {
    ...
    const base = format === "pdf"
      ? "/api/export/lmd-deployed-missionaries/pdf"
      : "/api/export/lmd-deployed-missionaries/xlsx";
