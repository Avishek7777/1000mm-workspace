...
const slides = [
  {
    ...
    caption: "29th Batch Missionary Training Program 2026 — BANC, Gazipur",
  },
  {
    src: "/images/projects/batch-29/batch-29-2.jpg",
    caption:
      "Trainees gathered for the opening of the four-week residential program",
  },
  {
    src: "/images/projects/batch-29/batch-29-3.jpg",
    caption: "Intensive classroom and practical ministry training in session",
  },
  {
    src: "/images/projects/batch-29/batch-29-4.jpg",
    caption: "Community outreach and health education activities",
  },
  {
    src: "/images/projects/batch-29/batch-29-5.jpg",
    caption: "Worship, spiritual formation, and fellowship at BANC Campus",
  },
  {
    src: "/images/projects/batch-29/batch-29-6.jpg",
    caption: "Graduates commissioned for mission service across Bangladesh",
  },
];

const AUTOPLAY_MS = 2500;

export default function Batch29Slider() {
