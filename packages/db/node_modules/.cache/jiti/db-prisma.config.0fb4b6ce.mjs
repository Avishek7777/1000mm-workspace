...
dotenv.config({ path: _path.default.join(__dirname, "../../.env") });var _default = exports.default =

(0, _config.defineConfig)({
  earlyAccess: true,
  schema: _path.default.join(__dirname, "prisma/schema.prisma"),
  seed: _path.default.join(__dirname, "prisma/seed.ts")
}); /* v9-5f015423dde35437 */
